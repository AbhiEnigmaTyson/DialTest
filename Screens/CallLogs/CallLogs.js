...
import { StyleSheet, Text, View, Image, TouchableOpacity, TextInput, TouchableWithoutFeedback, ActivityIndicator,ScrollView } from 'react-native'
...
export default function CallLogs({ navigation }) {
                ...
                <View style={styles.container}>
                    ...
                    <View style={styles.pickerContainer}>
                        <View style={styles.picker}>
                            <View style={styles.pickerSelected}>
                                <Text style={styles.pickerSelectedText} >All Calls</Text>
                            </View>
                            <TouchableWithoutFeedback onPress={() => { navigation.navigate('MissedLogs') }}>
                                <View style={styles.pickerUnit}>
                                    <Text style={styles.pickerUnitText} >Missed</Text>
                                </View>
                    ...
                    <ScrollView style={styles.scrollView}>
                    {
                        data && data.length > 0 && data.map((unit, index) => (
                            <CallLogUnit key={index} name={unit.customer_name} status={unit.status} direction={unit.direction} number={unit.target_number} />
                        ))
                    }
                    </ScrollView>
                </View>
