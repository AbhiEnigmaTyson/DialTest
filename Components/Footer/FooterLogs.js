...
import LogsSelected from "../../assets/Footer/logsSelected.svg"
import { useNavigation } from '@react-navigation/native';
export default function FooterLogs() {
    const navigation = useNavigation();
    return (
        <View style={styles.footer}>
            <TouchableWithoutFeedback  onPress={() => { navigation.navigate('CallLogs') }}>
                <View style={styles.footerUnitSelected}>
                    <LogsSelected height={22} width={25} />
                    <Text style={styles.footerUnitTextSelected}>Call Logs</Text>
                </View>
